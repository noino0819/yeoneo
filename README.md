...
**실전 예시 — 서울역행 M4130.** 아침 녹화 실측 기준, 이 동네에서 가장 빡센
노선입니다. 정류장당 **~3.4명**을 태우고(강남 방면 6001·6003은 1.8~2.2명),
집 앞 도착 직전 잔여좌석 **중앙값 7석** — 강남행(24~34석)과 달리 만석 직전으로
들어옵니다. 잔여 20석 · 5정거장 전 · 배차 10분(피크)이라면:
...
실측상 M4130은 평균보다 1.5배 빠르게 차므로 체감은 이보다 빠듯합니다 —
노선별 계수 분리가 다음 튜닝 후보인 이유예요.
